 ...
 * @since 1.0
 */
abstract class CApplication1 extends CModule
{
	/**
	...
	public function __construct($config=null)
	{
		...
		YiiBase1::setPathOfAlias('application',$this->getBasePath());
		YiiBase1::setPathOfAlias('webroot',dirname($_SERVER['SCRIPT_FILENAME']));
		YiiBase1::setPathOfAlias('ext',$this->getBasePath().DIRECTORY_SEPARATOR.'extensions');
