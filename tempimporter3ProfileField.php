...
class tempimporter3ProfileField extends CActiveRecord1
{
	const VISIBLE_ALL=3;
	...
	{
		return YiiBase1::app()->getModule('user')->tableProfileFields;
	}
    ...
    public function search()
    {
        ...
        return new CActiveDataProvider(get_class($this), array(
            'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>YiiBase1::app()->controller->module->fields_page_size,
			),
			'sort'=>array(
